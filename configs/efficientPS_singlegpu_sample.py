...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_bbox=dict(type='cabb', beta=1.0, loss_weight=1.0)),
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1024, 512), ratio_range=(0.5, 2.0), keep_ratio=True),
    dict(type='RandomFlip', flip_ratio=0.5),
    dict(type='RandomCrop', crop_size=(256, 512), transfer_crop_info=True, transfer_img=False),
...
optimizer_config = dict(grad_clip=None) #dict(max_norm=35, norm_type=2))
# learning policy
lr_config = dict(
    policy='step',
    warmup='linear',
